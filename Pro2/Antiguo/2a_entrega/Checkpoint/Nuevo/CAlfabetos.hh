...
class CAlfabetos {
    ...
    //Modificadoras
        ...
        */
        ...
        char codisusespe(map<string, Alfabeto>::iterator it, char m, char c);

        map<string, Alfabeto>::iterator devuelveit(string ida);

        char codisus(map<string, Alfabeto>::iterator it, char m, char c);
