...
class CMensajes {
    ...
    //Modificadoras
        /** @brief Lee y añade un mensaje.
      	...
      	*/
        void nm(CAlfabetos &alfas, string idm, string ida);
        ...
        */
        void codisusguard( CAlfabetos &alfas, string idm, string clave);
        ...
        */
        void codisus(CAlfabetos &alfas, string ida, string clave, string m);
